...
self.addEventListener('activate', function(e) {
    /*self.registration.pushManager.permissionState().then(function(permissionState) {
        console.log("permission state.", permissionState);
    });

    const applicationServerKey = urlB64ToUint8Array(PWAConfigurtion.applictionServerPublicKey);
    var subscriptionOptions = {
        userVisibleOnly: true,
        applicationServerKey: applicationServerKey
    }
    self.registration.pushManager.subscribe(subscriptionOptions).then(function(value) {
        console.log('value', JSON.stringify(value));
    })*/

    //self.registration.pushManager.permissionState().then(function(e){
